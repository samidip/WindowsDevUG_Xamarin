...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("Telerik.XamarinForms.Common.iOS.dll");
	xamarin_open_and_register ("Telerik.Xamarin.iOS.dll");
	xamarin_open_and_register ("Telerik.XamarinForms.DataControlsRenderer.iOS.dll");
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "WindowsDevUG.iOS.exe";
